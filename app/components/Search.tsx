...
export default function Search() {
    ...
    const handleSearch = async (text: string) => {
        ...
        if (text.length > 2) {
            try {
                const res = await fetch(`https://rickandmortyapi.com/api/character/?name=${text}`);
    ...
    return (
        <div className="relative w-full max-w-[720px] z-50">
            ...
            {suggestions.length > 0 && (
                <div className="absolute top-full left-0 w-full bg-white mt-2 rounded-xl shadow-2xl overflow-hidden border border-gray-100">
